...
const Create: React.FC<Props> = ({ darkMode, setDarkMode }): JSX.Element => {
    const fetchWordInfo = async (word: string): Promise<DictionaryAPIResponse> => {
        try {
                        ...
                        <div className='flex flex-col gap-5 items-center justify-center'>
                            <div className="flex gap-5 w-3/4">
                                <div className='w-1/2'>
                                    ...
                                    <input id='title' className='input-form-create' placeholder="Title" />    
                                </div>
                                <div className='w-1/2'>
                                    <label htmlFor='description' className='block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300'>Description</label>
                                    <input id='description' className='input-form-create' placeholder="Description" />    
                                </div>  
                            </div>
                            <div className='w-3/4'>
                                <AddWord />
...
const AddWord: React.FC = ({  }): JSX.Element => {
    return (
        <div className="w-full h-20 bg-gray-50 dark:bg-gray-700 transition-colors">
